...
def plot_curves(outdir: Path, gg, mm):
    ...
    ax.set_ylabel("Sup-grid error", fontsize=17)
    ax.set_title("Terminal-edge sup-grid error", fontsize=18)
    ax.legend(fontsize=13)
    fig.tight_layout()
    ax.tick_params(axis="both", labelsize=14)
    fig.tight_layout()
    fig.savefig(outdir / "edge_error.pdf", bbox_inches="tight")
    fig.savefig(outdir / "edge_error_sup.pdf", bbox_inches="tight")
    plt.close(fig)
    ...
    ax.set_xlabel("t", fontsize=17)
    ax.set_ylabel("Rescaled sup-grid error", fontsize=17)
    ax.set_title("Terminal-edge rescaled sup-grid error", fontsize=18)
    ax.legend(fontsize=13)
    fig.tight_layout()
    ax.tick_params(axis="both", labelsize=14)
    fig.tight_layout()
    fig.savefig(outdir / "edge_rescaled.pdf", bbox_inches="tight")
    fig.savefig(outdir / "edge_rescaled_sup.pdf", bbox_inches="tight")
    plt.close(fig)
